...
```text
I just published ClawGuard Agent v1.0.0-beta.1.
...
```text
I am looking for early testers for ClawGuard Agent v1.0.0-beta.1.
...
- GitHub release: https://github.com/denial-web/clawguard/releases/tag/v1.0.0-beta.1
