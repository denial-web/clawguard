...
- **2026-05-28** — **v1.0.0-beta.9** extended install to `clawhub:<slug>@<version>` (lockfile resolution) and HTTPS `.zip` archives with the same quarantine/scan/copy gate. See [RELEASE_NOTES_v1.0.0-beta.9.md](releases/RELEASE_NOTES_v1.0.0-beta.9.md) and install-url tests under `test/install-url/`.
