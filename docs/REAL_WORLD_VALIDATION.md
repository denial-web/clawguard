...
|---|---:|---|---|---|
| [AquaOne/ClawGuard](https://github.com/AquaOne/ClawGuard) | 303 | "Automated security audit & defense system for the OpenClaw plugin ecosystem" (CN). | Nothing — no English README; surface details unverified. | **Unknown.** Highest-star ClawGuard project. Cannot characterize interop without translation pass. Listed as gap below. |
| [JaydenBeard/clawguard](https://github.com/JaydenBeard/clawguard) | 138 | Activity monitor + kill switch for Clawdbot; real-time dashboard. | Nothing direct. | **Complementary.** Their surface is *runtime activity monitor + kill switch*; ours is *install gate + offline scan*. Series-composable. |
| [Gk0Wk/ClawGuard](https://github.com/Gk0Wk/ClawGuard) | 101 | "Antivirus for OpenClaw" — approve dangerous actions, scan skills, block secret leaks (per README). | Nothing direct. | **Closest-overlap project** in pure description; their surface is inside-OpenClaw approval prompts vs our install-time gate. Interop with `clawguard.check.v1` would be worth proposing once the schema sees external use. Outreach deferred until we have a clearer compose-pattern story (item below). |
| [SafeAgent-Beihang/clawguard](https://github.com/SafeAgent-Beihang/clawguard) | 49 | (no public description on repo) — academic / Beihang. | Nothing — no README to read. | **Unknown.** Listed as gap below. |
...
- **No translation pass on Chinese-language READMEs.** [AquaOne/ClawGuard](https://github.com/AquaOne/ClawGuard) (303 stars) is the highest-star ClawGuard project but ships a Chinese README; its concrete capabilities have not been verified against ours. Several other projects also have CN-only documentation ([hongshaoyu1166](https://github.com/hongshaoyu1166/clawguard), [ForceInjection](https://github.com/ForceInjection/ClawGuard), [legeling](https://github.com/legeling/ClawGuard), [xw-xmy](https://github.com/xw-xmy/clawguard)).
- **No README walk-through for repos without a public description.** [SafeAgent-Beihang/clawguard](https://github.com/SafeAgent-Beihang/clawguard) (49 stars) and [Claw-Guard/ClawGuard](https://github.com/Claw-Guard/ClawGuard) (17 stars) have no public description; capabilities unverified.
