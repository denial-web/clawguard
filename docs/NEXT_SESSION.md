...
- npm package: `@denial-web/clawguard@0.1.29`
- GitHub release: `v0.1.29`
...
npx --yes --package @denial-web/clawguard@0.1.29 clawguard scan /Users/hy/CascadeProjects/ClawGuard/examples/risky-skill --config ~/clawguard-test/.clawguard.json
```

Expected:

- version prints `0.1.29`
...
```bash
npx --yes --package @denial-web/clawguard@0.1.29 clawguard ...
```
...
Try it:
npx --yes --package @denial-web/clawguard@0.1.29 clawguard scan ./path/to/skill
