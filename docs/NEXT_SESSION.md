...
npx --yes --package @denial-web/clawguard@0.3.0 clawguard scan /Users/hy/CascadeProjects/ClawGuard/examples/risky-skill --config ~/clawguard-test/.clawguard.json
...
```bash
npx --yes --package @denial-web/clawguard@0.3.0 clawguard ...
```
...
Try it:
npx --yes --package @denial-web/clawguard@0.3.0 clawguard scan ./path/to/skill
