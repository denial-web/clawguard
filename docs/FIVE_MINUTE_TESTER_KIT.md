...
```bash
npx --yes --package @denial-web/clawguard@0.4.0 clawguard approvals demo-flow --keep
```
...
```bash
npx --yes --package @denial-web/clawguard@0.4.0 clawguard setup --framework openclaw --install-dir /path/to/trusted/skills
```
...
```bash
npx --yes --package @denial-web/clawguard@0.4.0 clawguard sop list
```
...
```bash
npx --yes --package @denial-web/clawguard@0.4.0 clawguard sop init --industry toy-shop --out toy-shop-close.json
npx --yes --package @denial-web/clawguard@0.4.0 clawguard sop check --industry toy-shop toy-shop-close.json
```
...
```bash
npx --yes --package @denial-web/clawguard@0.4.0 clawguard sop init --industry banking-fraud --out fraud-review.json
npx --yes --package @denial-web/clawguard@0.4.0 clawguard sop check --industry banking-fraud fraud-review.json
```
...
npx --yes --package @denial-web/clawguard@0.4.0 clawguard device plan --device-class security-camera --action record-media --data-class video-audio --task "Enable recording on storefront camera"
```
