...
```bash
npx --yes --package @denial-web/clawguard@0.1.35 clawguard approvals demo-flow --keep
```
...
```bash
npx --yes --package @denial-web/clawguard@0.1.35 clawguard setup --framework openclaw --install-dir /path/to/trusted/skills
```
...
```bash
npx --yes --package @denial-web/clawguard@0.1.35 clawguard sop list
```
...
```bash
npx --yes --package @denial-web/clawguard@0.1.35 clawguard sop init --industry toy-shop --out toy-shop-close.json
npx --yes --package @denial-web/clawguard@0.1.35 clawguard sop check --industry toy-shop toy-shop-close.json
```
...
```bash
npx --yes --package @denial-web/clawguard@0.1.35 clawguard sop init --industry banking-fraud --out fraud-review.json
npx --yes --package @denial-web/clawguard@0.1.35 clawguard sop check --industry banking-fraud fraud-review.json
```
...
```bash
npx --yes --package @denial-web/clawguard@0.1.35 clawguard device plan --device-class drone --action drone-takeoff --task "Take off for outdoor inspection"
npx --yes --package @denial-web/clawguard@0.1.35 clawguard device plan --device-class security-camera --action record-media --data-class video-audio --task "Enable recording on storefront camera"
```
